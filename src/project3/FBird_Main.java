...
public class FBird_Main extends JFrame implements ActionListener, MouseListener, KeyListener {
	...
	Stairsmodeend stairsmodeend=new Stairsmodeend();
	...
	public FBird_Main() {
		...
		stairsmodeend.setLocation(0, 0);
		stairsmodeend.setSize((int) (1000 * scale), (int) (1000 * scale));
		stairsmodeend.setBackground(Color.WHITE);
